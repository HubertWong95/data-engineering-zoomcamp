...
```
select count (1)
from gcp_dataset_kestra_hubert.yellow_tripdata
where filename like '%2020%'

return value: 24,648,499
```
...
```
select count (1)
from gcp_dataset_kestra_hubert.green_tripdata
where filename like '%2020%'

return value: 1,734,051
```
